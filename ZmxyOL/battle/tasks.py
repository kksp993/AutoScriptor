...
TASK_TABLE = {
    ...
    # 极寒深渊
    "岩貉星宫":{"location":("极寒深渊",0),"target":T("岩貉星宫", box=Box(0,662,1280,35).margin()),"idx":0, "exit_loc":330-EXIT_RADIUS,"diff":["普通", "困难", "噩梦", "灵狱"],"crash_suddenly":False},
    ...
    "獐王星宫":{"location":("极寒深渊",0),"target":T("獐王", box=Box(0,523,1280,187).margin()),"idx":0, "exit_loc":330-EXIT_RADIUS,"diff":["普通", "困难", "噩梦", "灵狱"],"crash_suddenly":False},
